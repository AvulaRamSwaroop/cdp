...
async function initializeAgent() {
  try {
    const llm = new ChatGroq({
      model: "llama3-70b-8192", // Llama 3 70B model from Groq
      apiKey: "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",
      // temperature: 0.2, // Optional: Lower temperature for more deterministic responses
    });
